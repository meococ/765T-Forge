...
public sealed class ForgeMcpTools
{
    ...
    [McpServerTool(Name = "forge_linework_dump", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_trace", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_topology", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_coverage", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_segments", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_compare", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
    ...
    [McpServerTool(Name = "forge_linework_transform", ReadOnly = true, Destructive = false, Idempotent = true, OpenWorld = false)]
