...
/// <summary>
/// Turns a <see cref="PdfProbeResult"/> into the tool result for
/// <c>forge_plot_to_pdf</c>: a failed probe is a failed call that still carries
/// the probe data and the verification block, not a success.
/// </summary>
